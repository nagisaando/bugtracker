  ...
  <!-- <body class="antialiased font-sans bg-gray-200"> -->
        <div class="container mx-auto px-4 sm:px-8">
            <div class="py-8">
                ...
                <div class="flex-1 ">
                    <h2 class="text-2xl font-semibold leading-tight">Bug Detail</h2>
                </div>
                <div class="flex-1 block relative">
                    <!-- <router-link to="/submitProject"> -->
                        ...
                        <div class="inline-flex float-right">
                            <router-link v-bind:to="`/projectDetail/${id}/BugEdit/${bugId}`">
                ...
                <div class="-mx-4 sm:-mx-8 px-4 sm:px-8 py-4 overflow-x-auto">
                    <div class="inline-block min-w-full shadow rounded-lg overflow-hidden bg-white">
                        <!-- <div class="hover:bg-gray-100 mb-10 lg:mb-0"> -->
                                    <div class="text-center px-5 py-5 border-b border-gray-200 bg-white text-xl w-full lg:w-auto block lg:table-cell relative lg:static">
                                        <span class="absolute top-0 left-0 bg-blue-200 px-2 py-1 text-xs font-bold uppercase">Bugs</span>
                                        {{  bug.title  }}
                                    </div>
                                    <div class="text-center px-5 py-8 border-b border-gray-200 bg-white text-sm w-full lg:w-auto block lg:table-cell relative lg:static">
                                        <span class=" absolute top-0 left-0 bg-blue-200 px-2 py-1 text-xs font-bold uppercase">Description</span>
                                        {{  bug.description  }}                               
                                    </div>
                                    
                                    <div class="text-center  px-5 py-5 border-b border-gray-200 bg-white text-sm w-full lg:w-auto block lg:table-cell relative lg:static">
                                        <span class=" absolute top-0 left-0 bg-blue-200 px-2 py-1 text-xs font-bold uppercase">Status</span>
                                        <span class="rounded py-1 px-3 text-xs font-bold" :class="bug.status === 1 ? 'bg-red-400' : 'bg-green-400'">
                    ...
                    <div class="info-card mx-auto md:-translate-x-20 translate-y-10 max-w-sm rounded-lg overflow-hidden shadow-lg bg-white">
                        <div class="flex flex-col min-h-full">
                            <div class="px-6 py-4 border-b">
                                <div class="text-xl text-center">Delete Bug Item</div>
                            </div>
                            <div class="px-6 py-10 flex-grow">
                                <p class="text-gray-700 text-base" v-if="!hasDeleted">
                                    Do you want to delete: {{  bug.title  }}?
                            ...
                            <div class="px-5 py-3 border-t bg-gray-100 flex justify-end">
                                ...
                                <button class="text-red-600 font-medium text-sm py-1 px-5 rounded hover:text-red-400" v-if="!hasDeleted" @click="deleteBugs">Delete</button>
        ...
        <!-- <transition name="fade" appear>
                <div class="modal-overlay main-content flex-1 bg-gray-100 mt-12 md:mt-2 pb-24 md:pb-5" v-if="showModal">
                    <div class="info-card mx-auto md:-translate-x-20 translate-y-10 max-w-sm rounded-lg overflow-hidden shadow-lg bg-white">
                        <div class="flex flex-col min-h-full">
                            <div class="px-6 py-4 border-b">
                                <div class="text-xl text-center">Delete Bug Item</div>
