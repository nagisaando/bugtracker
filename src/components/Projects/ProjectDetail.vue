                ...
                <div class="my-2 flex sm:flex-row flex-col">
                    <div class="flex-1 my-2 flex sm:flex-row flex-col">
                        <div class="flex flex-row mb-1 sm:mb-0">
                            <div class="relative">
                                <select
                                    class="appearance-none h-full rounded-l rounded-r-none border-l border-t border-b block w-full bg-white border-gray-400 text-gray-700 py-2 px-4 pr-8 leading-tight focus:outline-none focus:border-l focus:border focus:bg-white focus:border-gray-500"
